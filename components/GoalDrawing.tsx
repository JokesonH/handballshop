 ...
 *
 * This is the hero art. It exists because the whole proposition of the store
 * is "we sell the thing no one on this continent will ship you" — and a
 * dimensioned drawing of that thing says it faster and more credibly than a
 * stock photo of someone jumping.
 *
...
export default function GoalDrawing({
  ...
  return (
    ...
    >
      ...
      >
        <text x="40" y="352">IHF MATCH SPECIFICATION</text>
        <text x="40" y="366">POST PROFILE 80MM SQ · FIG. 1</text>
      </g>
    </svg>
  );
}
